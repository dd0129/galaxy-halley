...
//    }
    ...
    private Logger logger = LoggerFactory.getLogger(PreInitExecuter.class);
    ...
    public static void main(String[] args) throws Exception{
        ...
        PreInitExecuter init = (PreInitExecuter) context.getBean("preInit");
